      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link className="text-gray-300 hover:text-bookburst-amber transition-colors">9620820284</Link>
              </li>
              <li>
                <Link  className="text-gray-300 hover:text-bookburst-amber transition-colors">rasheedahmedsemail@gmail.com</Link>
              </li>
              {/* <li>
